...
/// <summary>
/// The AIEasyPlayer will fire completely randomly.
/// </summary>
public class AIEasyPlayer : AIPlayer
{
	...
	protected override void GenerateCoords(ref int row, ref int column)
	{
		do {
            ...
            //method will be used.
            //In easy mode, since the target list is never populated, _currentstate will always be searching.
    ...
    //If the stack list isn't populated the ai's _currentstate will always be searching.
    //ProcessShot must exist but is left empty so that the target list always remains empty.
